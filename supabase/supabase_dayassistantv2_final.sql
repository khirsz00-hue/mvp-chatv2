...
-- =============================================================================
-- Sync Queue Table (Phase 2B - Unified Task Management)
-- =============================================================================
...
-- Indexes for efficient sync queue querying
...
-- Row Level Security for sync queue
...
CREATE POLICY IF NOT EXISTS "Service role full access on sync queue" 
